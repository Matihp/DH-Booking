            ...
            <div className='divContainer'>
                ...
                {data.valid ? (
                  <div className='containerHeader'>
                    <p onClick={() => navigate('reservas')}className='pAdminHeader' style={{color:'black', padding:"15px"}}>Reservas</p>
                    {data.email == 'admin@gmail.com' ? (<p onClick={() => {navigate('/administration')}}className='pAdminHeader' style={{color:'black'}}>Administración</p>) : "" }
